...
public class MyDate {
    ...
    static {
        ...
        String[] str_day = { "first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eighth", "ninth",
                "tenth", "eleventh", "twelfth", "thirdteenth", "fourteenth", "fifteenth", "sixteenth", "seventeenth",
                "eighteenth", "nineteenth", "twenty", "twenty-first", "twenty-second", "twenty-third", "twenty-fourth",
                "twenty-fifth", "twenty-sixth", "twenty-seventh", "twenty-eighth", "twenty-ninth", "thirty",
                "thirty-first" };
    ...
    public MyDate(String day, String month, String year) {
        try {
            ...
            LocalDate date = LocalDate.parse(intDay + "/" + intMonth + "/" + intYear,
                    DateTimeFormatter.ofPattern("d/M/yyyy")); // neu nhap sai dua ve ngay mac dinh
